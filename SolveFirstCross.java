...
public class SolveFirstCross extends Model {
	...
	void doOneEdge(Color c1, Color c2, SubSolution solution)
	{
		...
		else if (edgePos[0] == 2 && edgePos[1] == 2 && edgePos[2] == 1) // the edge is placed
		{
			...
			fillAnswerTab(rubiksCubeFirstCross, solution.move, 2, solution.turn, 3, solution.message, message); // fully placed
		}
		else if (edgePos[0] == 2)
		{
			...
			{
				fillAnswerTab(rubiksCubeFirstCross, solution.move, 4, solution.turn, 2, solution.message, message);
				fillAnswerTab(rubiksCubeFirstCross, solution.move, 5, solution.turn, 1, solution.message, message);
				fillAnswerTab(rubiksCubeFirstCross, solution.move, 0, solution.turn, 2, solution.message, message); // placed (2, 1, 2)
				fillAnswerTab(rubiksCubeFirstCross, solution.move, 2, solution.turn, 3, solution.message, message); // fully placed (2, 2, 1)
			}
			else if (edgePos[1] == 0) // he's top of white face
			{
				fillAnswerTab(rubiksCubeFirstCross, solution.move, 3, solution.turn, 2, solution.message, message);
				fillAnswerTab(rubiksCubeFirstCross, solution.move, 5, solution.turn, 2, solution.message, message);
				fillAnswerTab(rubiksCubeFirstCross, solution.move, 0, solution.turn, 2, solution.message, message); // placed
				fillAnswerTab(rubiksCubeFirstCross, solution.move, 2, solution.turn, 3, solution.message, message); // fully placed
			}
		}
		...
		else
		{
			if (edgePos[1] == 1) 
			{
				...
				fillAnswerTab(rubiksCubeFirstCross, solution.move, 2, solution.turn, timesToTurn, solution.message, message); 				
				edgePos = findUnitaryEdge(rubiksCubeFirstCross, c1, c2);
				
				while (edgePos[0] != 2)
				{
					fillAnswerTab(rubiksCubeFirstCross, solution.move, faceOfOtherSideOfEdge, solution.turn, 1, solution.message, message);
					edgePos = findUnitaryEdge(rubiksCubeFirstCross, c1, c2);
				}
			}
			else
			{
				...
				fillAnswerTab(rubiksCubeFirstCross, solution.move, edgePos[0], solution.turn, 1, solution.message, message); 				
				edgePos = findUnitaryEdge(rubiksCubeFirstCross, c1, c2);
	...
	void doFirstCross()
	{
		...
		int[] edgePos = findUnitaryEdge(rubiksCubeFirstCross, Color.white, Color.red);
		while (edgePos[1] != 2)
		{
			fillAnswerTab(rubiksCubeFirstCross, solution.move, 2, solution.turn, 1, solution.message, message);
			edgePos = findUnitaryEdge(rubiksCubeFirstCross, Color.white, Color.red);
		}
